...
// Prefer menuconfig-controlled selection. Include sdkconfig to access CONFIG_ symbols.
#include "sdkconfig.h"

// If the provisional ST7789 240x320 configuration is selected via menuconfig,
// include the matching setup. Otherwise fall back to preserved HW657A setup
// or the library default `User_Setup.h` if neither symbol is defined.
#if defined(CONFIG_DISPLAY_ST7789_240X320) && CONFIG_DISPLAY_ST7789_240X320
#include <User_Setups/User_Setup_ST7789_240x320.h>
#elif defined(CONFIG_DISPLAY_HW657A) && CONFIG_DISPLAY_HW657A
#include <User_Setups/User_Setup_HW657A.h>
#else
